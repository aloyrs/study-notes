...
C is a high-level language designed for humans to read. Computers, however, only understand machine code (binary). Assembly is the closest human-readable representation of that binary. C tells the computer what to do (e.g., "Add these two numbers").

Assembly: Tells the computer exactly how to do it (e.g., "Take the value in Register A, add it to Register B, and store it in Register C").
...
# General form of memory addressing mode
